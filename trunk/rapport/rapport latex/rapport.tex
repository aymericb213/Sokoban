...
Les deadLocks (les caisses étant bloquées), ont plusieurs niveaux de test à passer avant d'être déclarée bloquée, il faut pas non seulement regarder son voisinage car une caisse peut ne pas pouvoir être déplacer sans que la partie soit fini.
