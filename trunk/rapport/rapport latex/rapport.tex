...
Il est possible de demander la résolution automatique du niveau.
\begin{figure}[!h]
\centering
...
Le niveau de sokoban, une fois lu dans un fichier .xsb, est stocké dans une grille d'objets pour les manipulations ultérieures. Le principal avantage de cette méthode est l'intuitivité de la représentation.
