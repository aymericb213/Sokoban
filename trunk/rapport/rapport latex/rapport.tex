...
Sur la série de niveaux originaux de Sokoban \cite{git}, le solveur n'est capable de résoudre que le premier, en 1,5 secondes. Les autres causent des dépassements mémoire. Cela dit, les niveaux originaux deviennent vite grands, complexes, et comportent de nombreuses caisses. Notre solveur étant plutôt simple, il n'est donc pas surprenant qu'il ne parvienne pas  résoudre ces niveaux.\\
